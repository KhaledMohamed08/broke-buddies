                    ...
                    <form action="{{ route('shops.store') }}" method="POST" id="shop-form">
                        ...
                        <div class="mb-4">
                            <label for="shop_category"
                                class="block text-sm font-medium text-gray-700">{{ __('Shop Category') }}</label>
                            <select id="shop_category" name="shop_category_id"
                        ...
                        <div class="flex mb-4">
                            <div class="flex-1 mr-2">
                                ...
                                <input type="text" id="name" name="name"
                                    class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                    placeholder="{{ __('Enter shop name') }}" required>
                            </div>
                        ...
                        <div x-data="{ categories: [] }">
                                ...
                                <div class="mt-6">
                                    <div class="bg-gray-50 p-4 rounded-lg shadow">
                                        ...
                                        <div class="mt-4">
                                            <template x-for="(item, itemIndex) in category.items"
                                                ...
                                                <div class="mt-4">
                                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                        <div>
                                                            <label class="block text-sm font-medium text-gray-700">Item
                                                                Name</label>
                                                            <!-- Bind the name to the category's name as key -->
                                                            <input type="text"
                                                                :name="'categories[' + category.name + '][items][' +
                                                                    itemIndex + '][name]'"
                                                                x-model="item.name"
                                                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                                            ...
                                                            <div class="mt-4">
                                                                <template x-for="(sizeItem, sizeIndex) in item.sizes"
                                                                    :key="sizeIndex">
                                                                    <div
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <!-- Bind the size to the category's name as key -->
                                                                            <select
                                                                                :name="'categories[' + category.name +
                                                                                    '][items][' + itemIndex +
                                                                                    '][sizes][' + sizeIndex + '][size]'"
                                                                                x-model="sizeItem.size"
                                                                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                                                                required>
                                                                                <option value="" disabled
                                                                                    selected>{{ __('Select Size') }}
                                                                                </option>
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <!-- Bind the price to the category's name as key -->
                                                                            <input type="number"
                                                                                :name="'categories[' + category.name +
                                                                                    '][items][' + itemIndex +
                                                                                    '][sizes][' + sizeIndex + '][price]'"
                                                                                min="1" x-model="sizeItem.price"
                                                                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                                                                placeholder="Enter price" required>
                                                                        </div>

                                                                        <div class="flex items-end">
                                                                            <x-danger-button class="m-1 p-1"
                                                                                type="button"
                                                                                @click="item.sizes.splice(sizeIndex, 1)">
                                                                                {{ __('-') }}
                                                                            </x-danger-button>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="flex items-center justify-start mt-4">
                                                                    <x-primary-button type="button"
                                                                        @click="item.sizes.push({ size: '', price: '' })">
                                                                        {{ __('Add Size/Price') }}
                                                                    </x-primary-button>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <!-- Bind the description to the category's name as key -->
                                                            <textarea
                                                                :name="'categories[' + category.name + '][items][' +
                                                                    itemIndex +
                                                                    '][description]'"
                                                                x-model="item.description" rows="4"
                                                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                                    ...
                                                    <div class="flex items-center justify-end mt-4">
                                                        <x-danger-button class="m-1" type="button"
                                            ...
                                            <div class="flex items-center justify-end mt-4">
                                                <x-primary-button class="m-1" type="button"
                                                    @click="category.items.push({ name: '', sizes: [{ size: '', price: '' }], description: '' })">
                                                    {{ __('Add New Item') }}
                                                </x-primary-button>
                                            </div>
                                        </div>
                            ...
                            <x-modal name="add-category-modal" focusable>
                                <div class="p-4">
                                    ...
                                    <input type="text" id="new-category-name" x-model="newCategoryName"
                                        class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                        required>
                                    <div class="flex justify-end space-x-3 mt-6">
                                        ...
                                        <x-primary-button type="button"
                                            @click="categories.push({ name: newCategoryName, items: [{ name: '', sizes: [{ size: '', price: '' }], description: '' }] }); newCategoryName = ''; $dispatch('close')">
                                            {{ __('Apply') }}
                                        </x-primary-button>
                                    </div>
                                </div>
